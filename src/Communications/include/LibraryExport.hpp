...
// a static library
#ifdef NETWORKING_STATIC_DEFINE
#   define NETWORKING_API
#   define NETWORKING_API_LOCAL // change to NETWORKING_INTERNAL?
...
#       define NETWORKING_LOCAL            __attribute__((visibility("hidden")))
#   else
#       define NETWORKING_API
#       define NETWORKING_LOCAL
#   endif
