...
// a static library
#ifdef I2C_STATIC_DEFINE
#   define I2C_API
#   define I2C_LOCAL // change to NETWORKING_INTERNAL?
...
#       ifdef I2C_EXPORTS
            ...
            // with GCC.
#           ifdef __GNUC__
#               define I2C_API  __attribute__((dllexport))
...
#           else
#               define I2C_API  __declspec(dllexport)
#           endif
...
#           ifdef __GNUC__
#               define I2C_API  __attribute__((dllimport))
#           else
#               define I2C_API  __declspec(dllimport)
#           endif
#       endif
#   endif
...
#   if __GNUC__ >= 4
#       define I2C_API              __attribute__((visibility("default")))
#       define I2C_LOCAL            __attribute__((visibility("hidden")))
#   else
#       define I2C_API
#       define I2C_LOCAL
#   endif
